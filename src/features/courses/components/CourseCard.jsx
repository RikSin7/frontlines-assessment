...
export const CourseCard = memo(function CourseCard({ course }) {
  return (
    <Card className="p-6  flex flex-col h-full hover:border-primary-500/50 transition-all duration-300">
      ...
      <p className="text-sm text-muted-foreground mb-4 flex-1  transition-all duration-300">
        {course.description}
      </p>

      <div className="flex items-center gap-4 text-sm text-muted-foreground pt-4 border-t border-border transition-all duration-300">
        <div className="flex items-center gap-1">
